...
use Src\Billing\Infrastructure\Projections\InvoiceProjector;
use Src\Billing\Infrastructure\Reactors\InvoicePaidReactor;
...
return [
    ...
    'auto_discover_projectors_and_reactors' => [
        // Kosong: projector & reactor kita berada di direktori src/ (DDD),
        // sehingga kita daftarkan secara eksplisit di bawah, bukan auto-scan.
    ],
     ...
     */
    'projectors' => [
        // Read model Billing (CQRS query-side) dibangun dari stream event.
        InvoiceProjector::class,
    ],
     ...
     */
    'reactors' => [
        // Efek samping saat InvoicePaid: tandai order lunas + beri akses kursus.
        InvoicePaidReactor::class,
    ],
