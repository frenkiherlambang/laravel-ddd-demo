            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->isStudent())
                        ...
                        <x-nav-link :href="route('my-courses.index')" :active="request()->routeIs('my-courses.*')">
                            {{ __('Kursus Saya') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->isStudent())
                ...
                <x-responsive-nav-link :href="route('my-courses.index')" :active="request()->routeIs('my-courses.*')">
                    {{ __('Kursus Saya') }}
                </x-responsive-nav-link>
            @endif
        </div>
